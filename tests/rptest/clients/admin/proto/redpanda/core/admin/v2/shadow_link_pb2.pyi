...
class _ShadowTopicStorageModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ShadowTopicStorageMode.ValueType], builtins.type):
    ...
    'Inherit source storage mode (default/existing behavior).'
    SHADOW_TOPIC_STORAGE_MODE_CLOUD: _ShadowTopicStorageMode.ValueType
    'Force cloud storage mode.'
    SHADOW_TOPIC_STORAGE_MODE_TIERED_CLOUD: _ShadowTopicStorageMode.ValueType
    'Force tiered cloud storage mode.'

class ShadowTopicStorageMode(_ShadowTopicStorageMode, metaclass=_ShadowTopicStorageModeEnumTypeWrapper):
    """Storage mode override for shadow topics created by a shadow link."""
...
'Force cloud storage mode.'
SHADOW_TOPIC_STORAGE_MODE_TIERED_CLOUD: ShadowTopicStorageMode.ValueType
'Force tiered cloud storage mode.'
...
class TopicMetadataSyncOptions(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal['auto_create_shadow_topic_filters', b'auto_create_shadow_topic_filters', 'effective_interval', b'effective_interval', 'exclude_default', b'exclude_default', 'interval', b'interval', 'paused', b'paused', 'shadow_topic_storage_mode', b'shadow_topic_storage_mode', 'start_at_earliest', b'start_at_earliest', 'start_at_latest', b'start_at_latest', 'start_at_timestamp', b'start_at_timestamp', 'start_offset', b'start_offset', 'synced_shadow_topic_properties', b'synced_shadow_topic_properties']) -> None:
        ...
